...
public class Main extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupToolbar(R.id.toolbar, "COOKING HELPER", R.color.colorPink, R.color.colorWhiteTrans, R.drawable.ic_burger);
        ...
        Glide.with(this)
                .load(Uri.parse("https://github.com/itlockit2/CookingHelper/blob/master/images/profile_crop.png?raw=true"))
                .transform(new CircleGlide(this))
                .into(imageView);
    }
    private void applyFontToMenuItem(MenuItem mi) {
        Typeface font = Typeface.createFromAsset(getAssets(), "fonts/yanolja_Regular.otf");
